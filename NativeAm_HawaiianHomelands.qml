...
<qgis styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" minScale="1e+08" labelsEnabled="0" version="3.4.1-Madeira" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" readOnly="0" maxScale="0" simplifyLocal="1" simplifyMaxScale="1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="singleSymbol" symbollevels="0">
    <symbols>
      <symbol alpha="0.252" type="fill" clip_to_extent="1" name="0">
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          ...
          <prop k="outline_color" v="175,75,0,255"/>
  ...
  <fieldConfiguration>
    ...
    <field name="NativeAmericanArea_FIPSCode">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="9" name="" field="GNIS_ID"/>
    <alias index="10" name="" field="Name"/>
    <alias index="11" name="" field="AreaSqKM"/>
    <alias index="12" name="" field="FType"/>
    <alias index="13" name="" field="FCode"/>
    <alias index="14" name="" field="NativeAmericanArea_FIPSCode"/>
    <alias index="15" name="" field="AdminType"/>
    <alias index="16" name="" field="Shape_Length"/>
    <alias index="17" name="" field="Shape_Area"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="NativeAmericanArea_FIPSCode"/>
    <default applyOnUpdate="0" expression="" field="AdminType"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="AreaSqKM" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="FType" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="FCode" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="NativeAmericanArea_FIPSCode" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="AdminType" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="NativeAmericanArea_FIPSCode"/>
    <constraint exp="" desc="" field="AdminType"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" hidden="0" name="AreaSqKM"/>
      <column type="field" width="-1" hidden="0" name="FType"/>
      <column type="field" width="-1" hidden="0" name="FCode"/>
      <column type="field" width="-1" hidden="0" name="NativeAmericanArea_FIPSCode"/>
      <column type="field" width="-1" hidden="0" name="AdminType"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="AdminType"/>
    ...
    <field editable="1" name="NativeAmericanArea_FIPSCode"/>
  ...
  <labelOnTop>
    <field labelOnTop="0" name="AdminType"/>
    ...
    <field labelOnTop="0" name="NativeAmericanArea_FIPSCode"/>
