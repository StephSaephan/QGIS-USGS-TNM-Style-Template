...
<qgis styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" minScale="1e+08" labelsEnabled="0" version="3.4.1-Madeira" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" readOnly="0" maxScale="0" simplifyLocal="1" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias index="6" name="" field="LOADDATE"/>
    <alias index="7" name="" field="NAME"/>
    <alias index="8" name="" field="TRAILNUMBER"/>
    <alias index="9" name="" field="FTYPE"/>
    <alias index="10" name="" field="FCODE"/>
    <alias index="11" name="" field="LENGTH"/>
    <alias index="12" name="" field="GNIS_ID"/>
    <alias index="13" name="" field="SHAPE_Length"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="TRAILNUMBER"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="TRAILNUMBER" constraints="0"/>
    ...
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="LENGTH" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="TRAILNUMBER"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" hidden="0" name="TRAILNUMBER"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="TRAILNUMBER"/>
  </editable>
  <labelOnTop>
    ...
    <field labelOnTop="0" name="TRAILNUMBER"/>
  </labelOnTop>
  <widgets/>
