...
<qgis styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" minScale="1e+08" labelsEnabled="0" version="3.4.1-Madeira" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" readOnly="0" maxScale="0" simplifyLocal="1" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias index="11" name="" field="FAA_Airport_Code"/>
    <alias index="12" name="" field="Surface_Material"/>
    <alias index="13" name="" field="Runway_Length"/>
    <alias index="14" name="" field="Runway_Width"/>
    <alias index="15" name="" field="Runway_Status"/>
    <alias index="16" name="" field="GNIS_ID"/>
    <alias index="17" name="" field="Shape_Length"/>
    <alias index="18" name="" field="Shape_Area"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="FAA_Airport_Code"/>
    <default applyOnUpdate="0" expression="" field="Surface_Material"/>
    <default applyOnUpdate="0" expression="" field="Runway_Length"/>
    <default applyOnUpdate="0" expression="" field="Runway_Width"/>
    <default applyOnUpdate="0" expression="" field="Runway_Status"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="FAA_Airport_Code" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="Surface_Material" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="Runway_Length" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="Runway_Width" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="Runway_Status" constraints="0"/>
    ...
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="Shape_Area" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="FAA_Airport_Code"/>
    <constraint exp="" desc="" field="Surface_Material"/>
    <constraint exp="" desc="" field="Runway_Length"/>
    <constraint exp="" desc="" field="Runway_Width"/>
    <constraint exp="" desc="" field="Runway_Status"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" hidden="0" name="FAA_Airport_Code"/>
      <column type="field" width="-1" hidden="0" name="Surface_Material"/>
      <column type="field" width="-1" hidden="0" name="Runway_Length"/>
      <column type="field" width="-1" hidden="0" name="Runway_Width"/>
      <column type="field" width="-1" hidden="0" name="Runway_Status"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="FAA_Airport_Code"/>
    ...
    <field editable="1" name="Runway_Length"/>
    <field editable="1" name="Runway_Status"/>
    <field editable="1" name="Runway_Width"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="Runway_Length"/>
    <field labelOnTop="0" name="Runway_Status"/>
    <field labelOnTop="0" name="Runway_Width"/>
